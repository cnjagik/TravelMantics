package com.coansinternational.www.travelmantics;
...
public class DealActivity extends AppCompatActivity {
    ...
    EditText txtPrice;
    TravelDeal deal;
    String url,pictureName,price,description,title,id;
    ImageView imageView;
    Button btnUpload;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (deal==null){
            deal= new TravelDeal(id, title,description,price,url,pictureName);
        }
        this.deal = deal;
